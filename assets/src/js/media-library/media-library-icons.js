...
/**
 * Edit (pencil) icon - matches @wordpress/icons pencil
 */
...
/**
 * Chart bar icon - matches @wordpress/icons chartBar
 */
export const barChartIcon = `
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" focusable="false">
			<path fill-rule="evenodd" clip-rule="evenodd" d="M11.25 5h1.5v15h-1.5V5zM6 10h1.5v10H6V10zm12 4h-1.5v6H18v-6z"></path>
		</svg>`;
