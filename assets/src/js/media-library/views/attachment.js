			...
			if ( undefined !== virtual && virtual ) {
				this.$el.append( `
					<div class="transcoding-status__loader" data-percent="100">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="1.6 6.5 17.4 15.1" fill="none">
							<path d="M9.89072 8.12232L4.05675 13.9563L2.52612 12.4257C1.6443 11.5438 2.06549 10.0365 3.27889 9.74077L9.89251 8.12411L9.89072 8.12232Z" fill="url(#paint0_linear_76_96)"/>
