	...
	$( document ).ready( function() {
		...
		$addGalleryButton.on( 'click', function( e ) {
			...
			const frame = wp.media( {
				title: __( 'Add Images and Videos to Product Gallery', 'godam-woo' ),
				multiple: true,
				library: {
					type: [ 'image', 'video' ],
				},
				button: {
					text: __( 'Add to Gallery', 'godam-woo' ),
				},
			} );
			...
			frame.on( 'select', function() {
				...
				if ( frame.content && typeof frame.content.mode === 'function' && frame.content.mode() === 'godam-woo' ) {
					return;
				}
