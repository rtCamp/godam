...
if ( empty( $gallery_items ) ) {
	...
	return '<div ' . wp_kses_data( $empty_wrapper_attrs ) . '><p class="godam-video-product-gallery__empty">' . esc_html__( 'No video products found.', 'godam-woo' ) . '</p></div>';
}
...
<div <?php echo wp_kses_data( $wrapper_attributes ); ?>>
										...
										<?php if ( $show_add_to_cart && $cta_product['in_stock'] ) : ?>
											<?php if ( 'variable' === $cta_product['type'] ) : ?>
												<a
													...
													aria-label="<?php echo esc_attr( sprintf( __( 'Select options for %s', 'godam-woo' ), $cta_product['name'] ) ); ?>"
												>
											...
											<?php else : ?>
												<button
													...
													<?php /* translators: %s: product name */ ?>
													aria-label="<?php echo esc_attr( sprintf( __( 'Add %s to cart', 'godam-woo' ), $cta_product['name'] ) ); ?>"
												>
							...
							<?php if ( $show_add_to_cart && $product['in_stock'] ) : ?>
								<?php if ( 'variable' === $product['type'] ) : ?>
									<a
										...
										<?php /* translators: %s: product name */ ?>
										aria-label="<?php echo esc_attr( sprintf( __( 'Select options for %s', 'godam-woo' ), $product['name'] ) ); ?>"
									>
										<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18" aria-hidden="true">
											<path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/>
										</svg>
								...
								<?php else : ?>
									<button
										...
										<?php /* translators: %s: product name */ ?>
										aria-label="<?php echo esc_attr( sprintf( __( 'Add %s to cart', 'godam-woo' ), $product['name'] ) ); ?>"
									>
	...
	<?php if ( 'carousel' === $layout && count( $gallery_items ) > 1 ) : ?>
		<button class="godam-video-product-gallery__nav godam-video-product-gallery__nav--prev" aria-label="<?php esc_attr_e( 'Previous', 'godam-woo' ); ?>">
			<svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
				<path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z" />
			</svg>
		</button>
		<button class="godam-video-product-gallery__nav godam-video-product-gallery__nav--next" aria-label="<?php esc_attr_e( 'Next', 'godam-woo' ); ?>">
			<svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
