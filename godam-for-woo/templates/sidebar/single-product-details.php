...
$full_star_svg  = sprintf(
	...
	esc_url( GODAM_WOO_URL . 'assets/src/images/rating-full-star.svg' ),
	esc_attr__( 'Full Star', 'godam-woo' )
);
$empty_star_svg = sprintf(
	'<img src="%s" alt="%s" width="16" height="16" style="vertical-align:middle;" />',
	esc_url( GODAM_WOO_URL . 'assets/src/images/rating-empty-star.svg' ),
	esc_attr__( 'Empty Star', 'godam-woo' )
);
...
<div class="godam-image-gallery is-collapsed">
	...
	<div class="godam-thumbnail-carousel">
		<button class="godam-thumbnail-nav godam-thumbnail-prev" aria-label="<?php echo esc_attr__( 'Previous thumbnails', 'godam-woo' ); ?>">
			...
			<div class="godam-thumbnail-track">
				<?php foreach ( $product_images as $index => $image_url ) : ?>
					<div class="godam-thumbnail-item <?php echo ( 0 === $index ) ? 'active' : ''; ?>" data-index="<?php echo esc_attr( $index ); ?>">
						...
						<img class="godam-thumbnail-image" src="<?php echo esc_url( $image_url ); ?>" alt="<?php echo esc_attr( sprintf( __( 'Image %d', 'godam-woo' ), $index + 1 ) ); ?>">
					</div>
				<?php endforeach; ?>
			</div>
		</div>

		<button class="godam-thumbnail-nav godam-thumbnail-next" aria-label="<?php echo esc_attr__( 'Next thumbnails', 'godam-woo' ); ?>">
