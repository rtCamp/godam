						...
						<div className="overflow-auto">
							<div className="flex gap-8 items-start">
								<div className="min-w-[350px] max-w-[350px] flex-grow">
									...
									<div className="analytics-info-container border-t border-gray-500">
										<div className="analytics-info flex justify-between">
											...
											<span id="engagement-rate" className="min-w-[90px]">
												0%
											</span>
										</div>
										<hr />
										<div className="analytics-info flex justify-between">
											...
											<span id="total-plays" className="min-w-[90px]">
												0
											</span>
										</div>
										<hr />
										<div className="analytics-info flex justify-between">
											...
											<span id="play-rate" className="min-w-[90px]">
												0%
											</span>
										</div>
										<hr />
								...
								<div className="min-w-[750px]">
									<h2 className="text-lg m-0 mb-2 min-w-[640px]">
										...
										<div className="video-container">
											...
											>
												...
												{ analyticsData?.meta?._rt_transcoded_url && (
													<source
														src={ analyticsData?.meta?._rt_transcoded_url || '' }
														type={
															analyticsData?.meta?._rt_transcoded_url.endsWith(
																'.mpd',
															)
