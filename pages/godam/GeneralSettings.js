								...
								{ plans.map( ( plan ) => (
									...
									>
										...
										<Button
											className="mb-5"
											variant="primary"
											href={ `https://frappe-transcoder-api.rt.gw/subscription/account-creation?plan_name=${ encodeURIComponent( plan.name ) }&ref=${ encodeURIComponent( window.location.href ) }` }
											target="_blank"
											rel="noopener noreferrer"
										>
											{ __( 'Subscribe', 'godam' ) }
