...
const AttachmentGrid = ( { handleAttachmentClick } ) => {
	...
	return (
		<>
			<div className="h-full overflow-auto godam-video-list-wrapper">
				<header
				...
				>
					<div className="bg-white border-b flex px-6 gap-8">
						...
						<div className="flex items-center max-w-[280px] w-full flex-grow">
							<input
								type="text"
								placeholder="Search for media"
								className="bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md h-10 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
								onChange={ ( e ) => {
