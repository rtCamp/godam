						...
						*/ }
						<div>
							...
							<ToggleControl
								...
								help={ __( 'If enabled, Transcoder will generate multiple video files with different bitrates for adaptive streaming', 'transcoder' ) }
							...
							*/ }
							...
							<div className="mt-4">
								...
								<div className="easydam-settings-help">
									{ __( 'Select one or more video qualities for delivery. Transcoder will generate videos with selected resolutions. Transcoding will be done to the appropriate resolution supported by the video, up to the max resolution of each video.', 'transcoder' ) }
									<br />
				...
				>
					<div>
						...
						<TextControl
							...
							help={ __( `This field specifies the number of video thumbnails that will be generated by the Transcoder. To choose from the generated thumbnails for a video, go to Media > Edit > Video Thumbnails. Thumbnails are only generated when the video is first uploaded. Maximum value is 10`, 'transcoder' ) }
						/>
					</div>
					...
					<div className="mt-4">
						...
						<ToggleControl
							...
							help={ __( 'If enabled, Transcoder will replace existing media thumbnails with regenerated ones after retranscoding. If disabled, media thumbnails will remain untouched', 'transcoder' ) }
						/>
					</div>
				</PanelBody>
			</Panel>
				...
				>
					...
					<div className="py-3 flex flex-col gap-2 opacity-90 relative">
						...
						<ToggleControl
							...
							help={ __( 'If enabled, Transcoder will add a watermark to the transcoded video', 'transcoder' ) }
						/>
