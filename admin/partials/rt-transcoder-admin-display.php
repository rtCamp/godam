							...
							<td>
								...
								<span class="rtm-tooltip">
									...
									<span class="rtm-tip">
										...
										esc_html_e( 'This field specifies the number of video thumbnails that will be generated by the GoDAM. To choose from the generated thumbnails for a video, go to ​Media > Edit > Video Thumbnails. Thumbnails are only generated when the video is first uploaded. Maximum value is 10.', 'transcoder' );
										?>
									</span>
								</span>
							</td>
							...
							<td>
								...
								<span class="rtm-tooltip">
									...
									<span class="rtm-tip">
										...
										esc_html_e( 'If enabled, GoDAM will replace existing media thumbnails with regenerated ones after retranscoding. If disabled, media thumbnails will remain untouched.', 'transcoder' );
										?>
									</span>
								</span>
							</td>
