		...
		vc_map(
			array(
				...
				'params'      => array(
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Content URL', 'godam' ),
						'param_name'  => 'seo_content_url',
						'value'       => '',
						'description' => esc_html__( 'URL of the video content.', 'godam' ),
						'group'       => esc_html__( 'SEO Settings', 'godam' ),
						'save_always' => true,
						'dependency'  => array(
							'element' => 'seo_override',
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Thumbnail URL', 'godam' ),
						'param_name'  => 'seo_thumbnail_url',
						'value'       => '',
						'description' => esc_html__( 'URL of the video thumbnail image.', 'godam' ),
						'group'       => esc_html__( 'SEO Settings', 'godam' ),
						'save_always' => true,
						'dependency'  => array(
							'element' => 'seo_override',
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Upload Date', 'godam' ),
						'param_name'  => 'seo_upload_date',
						'value'       => '',
						'description' => esc_html__( 'Upload date in ISO 8601 format (e.g., 2024-01-15T10:30:00+00:00).', 'godam' ),
						'group'       => esc_html__( 'SEO Settings', 'godam' ),
						'save_always' => true,
						'dependency'  => array(
							'element' => 'seo_override',
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__( 'Duration', 'godam' ),
						'param_name'  => 'seo_duration',
						'value'       => '',
						'description' => esc_html__( 'Duration in ISO 8601 format (e.g., PT1M30S for 1 minute 30 seconds).', 'godam' ),
						'group'       => esc_html__( 'SEO Settings', 'godam' ),
						'save_always' => true,
						'dependency'  => array(
							'element' => 'seo_override',
