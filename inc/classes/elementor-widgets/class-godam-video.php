...
class GoDAM_Video extends Base {
	...
	public function set_default_config() {
		return array(
			...
			'depended_styles' => array( 'godam-player-style', 'godam-player-frontend-style', 'godam-player-minimal-skin', 'godam-player-pills-skin', 'godam-player-bubble-skin', 'godam-player-pulse-skin', 'godam-player-luma-skin', 'godam-player-classic-skin' ),
		);
	}
