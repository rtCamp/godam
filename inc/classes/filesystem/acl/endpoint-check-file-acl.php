...
namespace RTGODAM\Inc\Filesystem\Acl;
 ...
 *
 * @param string|boolean $file_visibility Return one of RTGODAM\Inc\Filesystem\Acl\(FILE_IS_PUBLIC | FILE_IS_PRIVATE_AND_ALLOWED | FILE_IS_PRIVATE_AND_DENIED) to set visibility.
