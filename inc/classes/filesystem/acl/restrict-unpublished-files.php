...
namespace RTGODAM\Inc\Filesystem\Acl\Restrict_Unpublished_Files;

use const RTGODAM\Inc\Filesystem\Acl\FILE_IS_PUBLIC;
 ...
 *
 * @param string $file_visibility one of RTGODAM\Inc\Filesystem\Acl\(FILE_IS_PUBLIC | FILE_IS_PRIVATE_AND_ALLOWED | FILE_IS_PRIVATE_AND_DENIED).
 * @param string $file_path path to file to be checked for visibility.
 * @return string one of RTGODAM\Inc\Filesystem\Acl\(FILE_IS_PUBLIC | FILE_IS_PRIVATE_AND_ALLOWED | FILE_IS_PRIVATE_AND_DENIED)
 */
