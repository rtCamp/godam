...
require_once __DIR__ . '/class-wp-filesystem-godam-uploads.php';
...
class WP_Filesystem_GoDAM extends \WP_Filesystem_Base {

	/** @var WP_Filesystem_Direct */
	private $direct;

	/**
	 * @param array $dependencies Array that contains an instance of `WP_Filesystem_GoDAM_Uploads` and `WP_Filesystem_Direct`.
	 */
	 ...
	 *
	 * @return WP_Filesystem_GoDAM_Uploads|bool|mixed|WP_Filesystem_Direct
	 */
	private function get_transport_for_path( $filename, $context = 'read' ) {
		...
		// This is because wp_upload_dir will return a godam:// path.
